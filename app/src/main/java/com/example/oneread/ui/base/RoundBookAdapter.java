...
public class RoundBookAdapter extends RecyclerView.Adapter<RoundBookAdapter.ViewHolder>{
    Context context;
    List<Book> books = new ArrayList<>();
    HashMap<String, Boolean> isFollowed = new HashMap<>();
    public RoundBookAdapter() {
    }

    public RoundBookAdapter(Context context, List<Book> books) {
    ...
    public ViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View row = LayoutInflater.from(context).inflate(R.layout.book_item_circle, parent, false);
