...
public class DeleteChapterAdapter extends RecyclerView.Adapter<DeleteChapterAdapter.ViewHolder>{
    ...
    public DeleteChapterAdapter() {
    }

    public DeleteChapterAdapter(Context context, List<Chapter> chapters, List<Boolean> listCheck) {
